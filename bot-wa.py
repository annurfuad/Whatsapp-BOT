...
def Sendmsg():
    ...
    name = input("Masukan nama user atau grup : ")
    #enter the message
    msg = input("Masukan pesan : ")
    #enter the count
    count = int(input("Masukan Jumlah Pesan : "))
...
#user input
print("Pilih 1 untuk kirim broadcast pesan \nPilih 2 untuk mengirim gambar dan video \n Pilih 3  untuk keluar")
n = int(input())
if (n == 1):
    Sendmsg()
